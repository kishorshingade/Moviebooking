    ...
    <div className="px-6 md:px-16 lg:px-40 pt-30 md:pt-50">
      ...
      <div className="flex flex-col md:flex-row gap-8 max-w-6xl mx-auto">
        ...
        <div className="relative flex flex-col gap-3">
          ...
          <p className="text-grey-400 mt-2 text-sm leading-tight max-w-xl">
            {show.movie.overview}
          </p>
          ...
          <div className="flex items-center flex-wrap gap-4 mt-4">
            ...
            <a id="#dateSelect" href="#dateSelect"  className="px-10 py-3 text-sm bg-primary hover:bg-primary-dull
            ...
            <div className="flex items-center gap-4 px-4 w-max">
             {show.movie.casts.slice(0,12).map((cast,index)=> (
              <div key={index} className="flex flex-col items-center text-center">
                 <img src={cast.profile_path} className="rounded-full h-20 md:h-20
                 aspect-square object-cover" alt="" />
